...
<div class="row margin-bottom-10">
    ...
    <div class="col-md-6 text-right">
        <a href="<?= site_url(ADMIN . '/code'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i>
            Cancel</a>
    </div>
</div>
<div>
...
<div class="row margin-bottom-10 mobile_botton">
    ...
    <div class="col-md-6 text-right mobile_botton_main" style="display: flex;justify-content: end;">
        <form action="<?= base_url() ?>admin/code/upload_bulk" method="POST" enctype="multipart/form-data"
            style="display: flex;">
        ...
        <a href="<?= site_url(ADMIN . '/code/manage'); ?>" class="btn btn-lg btn-primary"><i
    ...
    <tbody>
        ...
        <tr class="odd gradeX">
            ...
            <td class="text-center">
                <div class="">
                    <img src="<?= get_site_image_src('code', $row->image); ?>" height="60"
            ...
            <td class="text-center">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-primary" role="menu">
                        ...
                        <li><a href="<?= site_url(ADMIN . '/code/delete/' . $row->id); ?>"
