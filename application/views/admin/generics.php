<?php if ($this->uri->segment(3) == 'manage') : ?>
    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-md-6 text-right">
            <a href="<?= site_url(ADMIN . '/generics'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
        </div>
    </div>
    <div>
        <hr>
...
<?php else : ?>
    ...
    <div class="row margin-bottom-10">
        ...
        <div class="col-md-6 text-right" style="display: flex;justify-content: end;">
            <form action="<?= base_url() ?>admin/generics/upload_bulk" method="POST" enctype="multipart/form-data" style="display: flex;">
            ...
            <a href="<?= site_url(ADMIN . '/generics/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>
        </div>
                ...
                <?php foreach ($rows as $row) : ?>
                    <tr class="odd gradeX">
                        ...
                        <td class="text-center">
                            <div class="">
                                <img src="<?= get_site_image_src('generics', $row->image, '', false); ?>" height="60" style="background-color:#eee">
                            </div>
                        </td>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary" role="menu">
                                    ...
                                    <li><a href="<?= site_url(ADMIN . '/generics/delete/' . $row->id); ?>" onclick="return confirm('Are you sure?');">Delete</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
