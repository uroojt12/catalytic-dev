                ...
                <div class="col-md-12">
                    ...
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <th>
                                <button type="button" class="btn btn-primary btn-md" data-toggle="modal" data-target="#requir_modal">Add Requirements</button>
                            </th>
                        </thead>
                        <tbody>
                            <?php if (count($documents) > 0) : $count = 0;  ?>
                                <?php foreach ($documents as $doc) : ?>
                                    <tr>
                                        ...
                                        <td><?= $doc->doc_name ?></td>
                                        <td>
                                            <form action="<?= base_url('admin/members/doc_status/' . $doc->id . '/' . $this->uri->segment(4)) ?>" role="form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                <div class="form-group">
                                                    <div class="col-md-9">
                                                        <label class="control-label"> Status</label>
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="col-md-12">
                                                            <button type="submit" class="btn btn-primary btn-sm" style="position: relative;top:25px"><i class="fa fa-save"></i> Save</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
                                        ...
                                        <?php if ($doc->status != 'requested') : ?>
                                            <td><a href="<?= base_url('/uploads/documents/' . $doc->document) ?>" target="_blank" class="btn btn-success btn-sm">Download Document</a></td>
                                        <?php endif; ?>
                                    </tr>
                                        ...
                                        <div class="panel-body">
                                            <div class="fileinput fileinput-new">
                                                <div class="fileinput-new thumbnail" style="max-width: auto;">
                                                    ...
                                                    <?php else : ?>
                                                        <img width="100%" src="<?= get_site_image_src('members/work-evidence', $work->evidence_file, '', false) ?>" alt="--">
                                                    <?php endif; ?>
                                ...
                                <div class="modal-dialog ">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <?php if ($file_ext == 'pdf') : ?>
                                                <iframe src="<?= base_url('uploads/members/work-evidence/' . $work->evidence_file) ?>" frameborder="0" style="width: 100%; height:500px"></iframe>
                                            <?php else : ?>
                                                <img width="100%" src="<?= get_site_image_src('members/work-evidence', $work->evidence_file, '', false) ?>" alt="--">
                                            <?php endif; ?>
                                        </div>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-primary" role="menu">
                                            ...
                                            <?php if ($row->mem_featured == '0') : ?>
                                                <li><a href="<?= base_url(ADMIN); ?>/members/featured/<?= $row->mem_id; ?>">Mark Featured</a></li>
                                            <?php else : ?>
                                                <li><a href="<?= base_url(ADMIN); ?>/members/unfeatured/<?= $row->mem_id; ?>">Un-mark Featured</a></li>
                                            <?php endif; ?>

                                            <?php if ($row->mem_type == 'professional') :  ?>
                                                <li><a href="<?= base_url(ADMIN); ?>/members/manage_subscription/<?= $row->mem_id; ?>">Manage Subscription</a></li>
                                                <li><a href="<?= base_url(ADMIN); ?>/members/manage_work_evidence/<?= $row->mem_id; ?>">Manage Work Evidence</a></li>
            ...
            <div class="vertical-alignment-helper">
                <div class="modal-dialog vertical-align-center">
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?= base_url('admin/members/add_document_requirements/' . $this->uri->segment(4)) ?>" method="POST">
                            <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered newTable" id="newTable">
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text" name="doc_name[]" id="doc_name" value="" class="form-control" placeholder="Document Name">
                                            </td>
