<main>
    <!-- ====== -->
    <section class="small_banner gene_banner" style="background-image:url('<?= get_site_image_src("images/", $site_content['image1']) ?>')">
        <div class="contain">
            <div class="inner">
                ...
                <div class="search">
                    <form id="filter-form-gen" action="" method="post">
                        <input type="text" name="search_generics" id="search_generics" placeholder="Search Generics" class="txtBox">
                        <div class="button">
                            <button>
