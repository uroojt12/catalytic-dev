                ...
                <table style="background: #fff; color: #333; font-size: 13px; border-collapse: collapse;" width="100%" cellspacing="0" cellpadding="5" border="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?=$mem_data['name']?> have submitted a query. Please check out the detail.
                            <br/>
                            <br/>
                            <strong style="color:#000;">Name: </strong><?=$mem_data['customer_name']?><br/>
                            <strong style="color:#000;">Email: </strong><?=$mem_data['email']?><br/>
                            <strong style="color:#000;">Comment: </strong><?=$mem_data['msg']?>
                            <br/>
                            <br/>
                            Kind Regards
                            <br/>
