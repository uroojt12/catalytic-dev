                ...
                <table style="background: #fff; color: #333; font-size: 13px; border-collapse: collapse;" width="100%" cellspacing="0" cellpadding="5" border="0">
                    <tbody>
                        ...
                        <tr>
                            ...
                            You or someone else has requested to reset the password for your account. If you initiated this request, please reset your password by following the link below:
                            <br/>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td style="padding: 10px; font-size: 15px; line-height: 29px;">
                                If you suspect someone may be using your account, please let us know via <a href="mailto:<?=$site_settings->site_email?>" style="color:#1355ff;text-decoration: underline;"><?=$site_settings->site_email?></a>
                                <br/>
                            </td>
                        </tr>
                        <tr height="5"></tr>
