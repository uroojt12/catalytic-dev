...
<script src="<?= base_url() ?>adminassets/js/subadmin-neon-change.js"></script>

<script src="<?= base_url() ?>adminassets/js/neon-change.js"></script>
<script src="<?= base_url() ?>adminassets/js/neon-login.js"></script>
