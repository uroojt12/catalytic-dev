...
<head>
    ...
    <link rel="stylesheet"
        href="<?= base_url('adminassets/js/jquery-ui/css/no-theme/jquery-ui-1.10.3.custom.min.css'); ?>">
...
<body class="page-body  skin-white">
    ...
    <link href="<?= base_url('adminassets/js/datatables/responsive/css/datatables.responsive.css'); ?>"
        rel="stylesheet">
    ...
    jQuery(document).ready(function($) {
        ...
        let order = ($('th.sortBy').index() > -1 && $('th.sortBy').data("order")) ? $('th.sortBy').data(
            "order") : 'asc';
            ...
            $(document).on('click', '.crosBtn', function() {
                ...
                $.ajax({
                    ...
                    success: function(rs) {
                        ...
                        mianUpload.find('input[type="hidden"]').attr('disabled', true)
                            .val('');
                ...
                xhr.onreadystatechange = function() {
                    ...
                    if (this.readyState == 4 && this.status == 200) {
                        ...
                        if (jsonResponse.upload_status == 1) {
                            ...
                            mianUpload.find('input[type="hidden"]').attr('disabled', false).val(
                                jsonResponse.image);
    ...
    jQuery(".addNewRowTbl").click(function() {
        ...
        clonedRow.find('td:last-child').html(
            '<td class="text-center"><a href="javascript:void(0)" class="delNewRowTbl" id="delNewRowTbl"><i class="fa fa-minus" aria-hidden="true"></i></a></td>'
        );
    ...
    jQuery(".card-repeater-add-btn").click(function() {
        ...
        clonedRow.find('input').val('').end();
        clonedRow.find('.card_repeater-remove-btn').html(
