<?php echo getBredcrum(ADMIN, array('#' => 'Code Page')); ?>
<?php echo showMsg(); ?>
<div class="row margin-bottom-10">
    <div class="col-md-6">
        <h2 class="no-margin"><i class="entypo-window"></i> Update <strong>Code Page</strong></h2>
    </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <label for="banner_btn_url" class="control-label">Button url <span class="symbol required">*</span></label>
