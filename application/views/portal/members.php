...
<div class="row margin-bottom-10">
    ...
    <div class="col-md-6 text-right">
        <a href="<?php echo base_url(SUBADMIN . '/members'); ?>" class="btn btn-lg btn-default"><i
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="mem_fullname"
                            value="<?php if (isset($row->mem_fname)) echo get_mem_name($row->mem_id); ?>"
            ...
            <td class="text-center">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-primary" role="menu">
                        ...
                        <li><a
                                href="<?php echo base_url(SUBADMIN); ?>/members/active/<?php echo $row->mem_id; ?>">Active</a>
                        </li>
                        <?php else : ?>
                        <li><a
                                href="<?php echo base_url(SUBADMIN); ?>/members/inactive/<?php echo $row->mem_id; ?>">Inactive</a>
                        </li>
                        <?php endif; ?>
                        <li><a
                                href="<?php echo base_url(SUBADMIN); ?>/members/manage/<?php echo $row->mem_id; ?>">Edit</a>
                        </li>

                        <li class="divider"></li>
                        <li><a href="<?php echo base_url(SUBADMIN); ?>/members/delete/<?php echo $row->mem_id; ?>"
