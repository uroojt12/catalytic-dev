        ...
        <form role="form" method="post" class="form-horizontal form-groups-bordered validate" novalidate="novalidate" enctype="multipart/form-data">
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="order_no" class="control-label">Order No <span class="symbol required">*</span></label>
                        <input type="number" name="order_no" id="order_no" value="<?= $row['order_no'] ?>" class="form-control" required>
                    </div>
                    <div class="clearfix"></div>
                    <div class="col-md-12">
                        <h3>Meta Tags</h3>
