<?php if ($this->uri->segment(3) == 'manage') : ?>
    <?= showMsg(); ?>
    <?= getBredcrum(SUBADMIN, array('#' => 'Add/Update Testimonial')); ?>
    <div class="row margin-bottom-10">
        ...
        <div class="col-md-6 text-right">
            <a href="<?= site_url(SUBADMIN . '/testimonials'); ?>" class="btn btn-lg btn-default"><i class="fa fa-arrow-left"></i> Cancel</a>
        </div>
    </div>
...
<?php else : ?>
    <?= showMsg(); ?>
    <?= getBredcrum(SUBADMIN, array('#' => 'Manage Testimonials')); ?>
    <div class="row margin-bottom-10">
        <div class="col-md-6">
            <h2 class="no-margin"><i class="entypo-list"></i> Manage <strong>Testimonials</strong></h2>
        </div>
        <div class="col-md-6 text-right">
            <a href="<?= site_url(SUBADMIN . '/testimonials/manage'); ?>" class="btn btn-lg btn-primary"><i class="fa fa-plus-circle"></i> Add New</a>
        </div>
    </div>
                        ...
                        <td class="text-center">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-primary" role="menu">
                                    <li><a href="<?= site_url(SUBADMIN . '/testimonials/manage/' . $row->id); ?>">Edit</a></li>
                                    <li><a href="<?= site_url(SUBADMIN . '/testimonials/delete/' . $row->id); ?>" onclick="return confirm('Are you sure?');">Delete</a></li>
                                </ul>
                            </div>
                        </td>
                    </tr>
