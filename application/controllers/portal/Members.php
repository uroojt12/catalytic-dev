<?php
class Members extends SUBADMIN_Controller
{
    ...
    public function index()
    {
        ...
        $this->data['pageView'] = SUBADMIN . '/members';
        $this->data['rows'] = $this->member->getMembers(array('site_id' => $this->subadmin->site_id), '', '', 'desc');
    ...
    function add_document_requirements($mem_id)
    {
        ...
        redirect(SUBADMIN . '/members/manage/' . $mem_id, 'refresh');
    }
